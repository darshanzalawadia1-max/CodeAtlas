...
export const AnalyticsScreen: React.FC = () => {
  ...
  const incidentTypesData = [
    { type: "Structure Fires", count: 8, pct: 33, color: "bg-[#ff6b4a]" },
    { type: "Vehicle Collisions", count: 6, pct: 25, color: "bg-[#f5b544]" },
    { type: "Medical Emergencies", count: 5, pct: 21, color: "bg-[#4f9cff]" },
    { type: "Infrastructure / Gas", count: 3, pct: 13, color: "bg-[#7c6bea]" },
    { type: "Special Operations", count: 2, pct: 8, color: "bg-[#aab0c5]" },
  ];

  const hourlyTrends = [
    { hour: "00:00", incidents: 2, avgResponseMin: 5.8 },
    { hour: "02:00", incidents: 1, avgResponseMin: 6.1 },
    { hour: "04:00", incidents: 3, avgResponseMin: 5.5 },
    { hour: "06:00", incidents: 7, avgResponseMin: 7.2 },
    { hour: "08:00", incidents: 12, avgResponseMin: 6.7 },
    { hour: "10:00", incidents: 9, avgResponseMin: 6.4 },
    { hour: "12:00", incidents: 8, avgResponseMin: 6.3 },
    { hour: "14:00", incidents: 10, avgResponseMin: 6.9 },
  ];

  const affectedZones = [
    { zone: "Sector A (North Arterial)", risk: "High", activeCalls: 7, avgArrival: "5m 40s" },
    { zone: "Sector B (Downtown Commercial)", risk: "Critical", activeCalls: 9, avgArrival: "6m 12s" },
    { zone: "Sector C (Harbor Transit Bore)", risk: "Medium", activeCalls: 5, avgArrival: "7m 05s" },
    { zone: "Sector D (East Industrial Park)", risk: "Moderate", activeCalls: 3, avgArrival: "6m 48s" },
  ];
    ...
    <div className="space-y-6 animate-fadeIn text-slate-900">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-slate-200/90 bg-white/80 backdrop-blur-md p-4 shadow-xs">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-3xl font-extrabold font-mono text-indigo-600">81.8%</span>
            <span className="text-xs font-semibold text-slate-500">(18 of 22 active)</span>
          </div>
